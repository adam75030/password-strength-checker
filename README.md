...
## Functionality:
- This program accepts an input string from the command line and rates the string based on how secure it would be as a password. It rates the password based on length, upper and lowercase letters, digits, and special symbols. The more random and varied the password is, the higher the security score will be.
...
## Limitations:
- This is a very basic password checker. It does not check for common words or repeated phrases that are often guessed in brute-force attacks.
